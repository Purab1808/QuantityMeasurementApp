...
class QuantityMeasurementAppTest {
    ...
    void testLengthUnitEnum_FeetConstant() {
        assertEquals(1.0, QuantityMeasurementApp.Length.LengthUnit.FEET.toBase(1.0));
    }

    @Test
    void testLengthUnitEnum_InchesConstant() {
        assertEquals(1.0 / 12.0, QuantityMeasurementApp.Length.LengthUnit.INCH.toBase(1.0), 1e-6);
    }

    @Test
    void testLengthUnitEnum_YardsConstant() {
        assertEquals(3.0, QuantityMeasurementApp.Length.LengthUnit.YARD.toBase(1.0));
    }

    @Test
    void testLengthUnitEnum_CentimetersConstant() {
        assertEquals(1.0 / 30.48, QuantityMeasurementApp.Length.LengthUnit.CM.toBase(1.0), 1e-6);
    }

    @Test
    void testConvertToBaseUnit_FeetToFeet() {
        assertEquals(5.0, QuantityMeasurementApp.Length.LengthUnit.FEET.toBase(5.0));
    }

    @Test
    void testConvertToBaseUnit_InchesToFeet() {
        assertEquals(1.0, QuantityMeasurementApp.Length.LengthUnit.INCH.toBase(12.0), 1e-6);
    }
    ...
    void testConvertToBaseUnit_CentimetersToFeet() {
        assertEquals(1.0, QuantityMeasurementApp.Length.LengthUnit.CM.toBase(30.48), 1e-6);
    }

    @Test
    void testConvertFromBaseUnit_FeetToFeet() {
        assertEquals(2.0, QuantityMeasurementApp.Length.LengthUnit.FEET.fromBase(2.0));
    }

    @Test
    void testConvertFromBaseUnit_FeetToInches() {
        assertEquals(12.0, QuantityMeasurementApp.Length.LengthUnit.INCH.fromBase(1.0), 1e-6);
    }

    @Test
    void testConvertFromBaseUnit_FeetToYards() {
        assertEquals(1.0, QuantityMeasurementApp.Length.LengthUnit.YARD.fromBase(3.0));
    }

    @Test
    void testConvertFromBaseUnit_FeetToCentimeters() {
        assertEquals(30.48, QuantityMeasurementApp.Length.LengthUnit.CM.fromBase(1.0), 1e-6);
    }
    ...
    void testQuantityLengthRefactored_AddWithTargetUnit() {
        QuantityMeasurementApp.Length l1 = new QuantityMeasurementApp.Length(1.0, QuantityMeasurementApp.Length.LengthUnit.FEET);
        QuantityMeasurementApp.Length l2 = new QuantityMeasurementApp.Length(12.0, QuantityMeasurementApp.Length.LengthUnit.INCH);
        QuantityMeasurementApp.Length result = QuantityMeasurementApp.Length.add(l1, l2, QuantityMeasurementApp.Length.LengthUnit.YARD);
    ...
    void testRoundTripConversion_RefactoredDesign() {
        QuantityMeasurementApp.Length l = new QuantityMeasurementApp.Length(10.0, QuantityMeasurementApp.Length.LengthUnit.FEET);
    ...
    void testEqualitySameObject() {
        QuantityMeasurementApp.Length l = new QuantityMeasurementApp.Length(5.0, QuantityMeasurementApp.Length.LengthUnit.FEET);
        assertEquals(l, l);
    }

    @Test
    void testEqualityDifferentUnits() {
        QuantityMeasurementApp.Length l1 = new QuantityMeasurementApp.Length(3.0, QuantityMeasurementApp.Length.LengthUnit.FEET);
        QuantityMeasurementApp.Length l2 = new QuantityMeasurementApp.Length(1.0, QuantityMeasurementApp.Length.LengthUnit.YARD);
        assertEquals(l1, l2);
    }
    ...
    void testConversionPrecision() {
        QuantityMeasurementApp.Length l = new QuantityMeasurementApp.Length(2.54, QuantityMeasurementApp.Length.LengthUnit.CM);
